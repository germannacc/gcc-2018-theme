...
<?php $video_section_heading = get_field('video_section_heading'); ?>
<?php $video_section_text = get_field('video_section_text'); ?>
<?php $video_section_button_url = get_field('video_section_button_url'); ?>
<?php $video_section_button_text = get_field('video_section_button_text'); ?>
