...
if ( ! function_exists( 'gcc_wp_2018_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function gcc_wp_2018_posted_by() {
		$byline = sprintf(
			/* translators: %s: post author. */
			esc_html_x( 'by %s', 'post author', 'gcc-wp-2018' ),
			...
			comments_popup_link(
				sprintf(
					wp_kses(
						...
						__( 'Leave a Comment<span class="screen-reader-text"> on %s</span>', 'gcc-wp-2018' ),
						array(
							'span' => array(
								'class' => array(),
							),
