...
if (is_page('home')) wp_enqueue_style( 'gcc-wp-2018-slider', get_template_directory_uri() . '/dist/css/owl.carousel.min.css', array(), '201831', 'all' );
...
wp_enqueue_script( 'gcc-wp-2018-jquery', '', array(), false, true );
...
if (is_page('home')) wp_enqueue_script('gcc-wp-2018-owl', get_template_directory_uri() . '/dist/scripts/owl.carousel.min.js', array(), '201831', true);

wp_enqueue_script( 'gcc-wp-2018-scripts', get_template_directory_uri() . '/dist/scripts/main.min.js', array(), '201831', true );

if (is_page('home')) wp_enqueue_script( 'gcc-wp-2018-slider', get_template_directory_uri() . '/dist/scripts/slider.js', array(), '201831', true );
